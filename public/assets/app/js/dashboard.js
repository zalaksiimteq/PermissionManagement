            ...
            function() {
                ...
                function() {
                    ...
                    function r(t, a, r) {
                        var o = "",
                            n = "";
                        a - t < 100 || "Today" == r ? (o = "Today:", n = t.format("Do MMM, YYYY")) : "Yesterday" == r ? (o = "Yesterday:", n = t.format("MMM D")) : n = t.format("MMM D") + " - " + a.format("MMM D"), e.find(".m-subheader__daterange-date").html(n), e.find(".m-subheader__daterange-title").html(o)
                    }
